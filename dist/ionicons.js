(function () {
  ...
  function config($sceDelegateProvider) {
    ...
    $sceDelegateProvider.resourceUrlWhitelist(whitelist.concat([
      'https://npmcdn.com/angular-icons@1.0.10/dist/icons/ionicons/**',
      'https://cdn.jsdelivr.net/angular-icons/1.0.10/icons/ionicons/**',
      'https://unpkg.com/angular-icons@1.0.10/dist/icons/ionicons/**'
    ]));
  }
  ...
  function Ionicons() {
    ...
    this.$get = function () {
      ...
      function getAssetPath() {
        switch (assetCdn) {
          case 'unpkg':
            return 'https://unpkg.com/angular-icons@1.0.10/dist/icons/ionicons/';
          case 'npmcdn':
            return 'https://npmcdn.com/angular-icons@1.0.10/dist/icons/ionicons/';
          case 'jsdelivr':
            return 'https://cdn.jsdelivr.net/angular-icons/1.0.10/icons/ionicons/';
          default:
            return assetPath;
        }
      }

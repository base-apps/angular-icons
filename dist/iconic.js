(function () {
  ...
  function config($sceDelegateProvider) {
    ...
    $sceDelegateProvider.resourceUrlWhitelist(whitelist.concat([
      'https://npmcdn.com/angular-icons@1.0.9/dist/icons/iconic/**',
      'https://cdn.jsdelivr.net/angular-icons/1.0.9/icons/iconic/**',
      'https://unpkg.com/angular-icons@1.0.9/dist/icons/iconic/**'
    ]));
  }
  ...
  function Iconic() {
    ...
    this.$get = function () {
      ...
      function getAssetPath() {
        switch (assetCdn) {
          case 'unpkg':
            return 'https://unpkg.com/angular-icons@1.0.9/dist/icons/iconic/';
          case 'npmcdn':
            return 'https://npmcdn.com/angular-icons@1.0.9/dist/icons/iconic/';
          case 'jsdelivr':
            return 'https://cdn.jsdelivr.net/angular-icons/1.0.9/icons/iconic/';
          default:
            return assetPath;
        }
      }
